...
export function TopicListPage(props: TopicListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getTopics({
        relations: ['user', 'audio_record.count', 'note.count', 'photo.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('audio_record', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'audio_record',
          header: 'Audio Record',
          accessorKey: 'audio_record',
          cell: ({ row: { original: record } }: any) => record?._count?.audio_record,
        }
      : null,
    ...
    hasAccess('photo', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          header: 'Photo',
          accessorKey: 'photo',
          cell: ({ row: { original: record } }: any) => record?._count?.photo,
        }
      : null,
