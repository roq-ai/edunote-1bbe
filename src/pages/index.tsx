  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="EduNote - Empowering students to capture, share, and learn from classroom moments. A collection of topics at your fingertips for comprehensive learning. Your journey to knowledge, simplified."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`EduNote - Empowering students to capture, share, and learn from classroom moments. A collection of topics at your fingertips for comprehensive learning. Your journey to knowledge, simplified.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Student User" type="student-user" abilities={appConfig.ownerAbilities} />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
