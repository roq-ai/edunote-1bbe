...
import { getAudioRecordById, updateAudioRecordById } from 'apiSdk/audio-records';
...
function AudioRecordEditPage() {
  ...
  const handleSubmit = async (values: AudioRecordInterface, { resetForm }: FormikHelpers<any>) => {
    setFormError(null);
    try {
      const updated = await updateAudioRecordById(id, values);
      mutate(updated);
      resetForm();
