...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'AssignmentCreated.create': {
    roles: ['student-user', 'teacher-user'],
    key: 'assignmentId',
    tenantPath: [],
    userPath: [],
  },
  'GradePosted.update': { roles: ['student-user'], key: 'gradeId', tenantPath: [], userPath: [] },
  'DiscussionStarted.create': {
    roles: ['student-user', 'teacher-user'],
    key: 'discussionId',
    tenantPath: [],
    userPath: [],
...
const ownerRoles: string[] = ['student-user'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['student-user', 'teacher-user'];
